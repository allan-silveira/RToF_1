...
#  opp_makemake -f --deep -O out -KINET4_PROJ=E:/omnetpp-5.6.2-src-windows/omnetpp-5.6.2/samples/inet4 -DINET_IMPORT -I. -I$$\(INET4_PROJ\)/src -L$$\(INET4_PROJ\)/src -lINET$$\(D\)
#
